...
namespace diesel {
  ...
  bool AreLoadParameters32Bit(const DieselFormatsLoadingParameters& version) {
    return (version.sourcePlatform != diesel::FileSourcePlatform::WINDOWS_64 && version.sourcePlatform != diesel::FileSourcePlatform::LINUX_64) && version.version != EngineVersion::RAID_WORLD_WAR_II_LATEST;
